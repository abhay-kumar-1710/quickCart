      ...
      {userCartItems?.length > 0 ? (
        <div className="flex justify-center w-[90%] mx-auto py-10 gap-5  flex-col items-center lg:flex-row-reverse lg:items-start ">
          <div className="w-[100%] p-5 py-8 flex justify-start items-center flex-col gap-5  rounded-2xl shadow-lg shadow-zinc-800  lg:w-[75%] xl:w-[45%]">
            ...
            <div className="w-[100%] sm:w-[80%] flex justify-between items-center px-2 sm:px-8">
              <h4 className="text-lg sm:text-xl font-medium">Items Price :</h4>
              <span className="text-lg sm:text-xl font-medium">
                {formatPrice(itemsPrice)}
              </span>
            </div>
            <div className="w-[100%] sm:w-[80%] flex justify-between items-center px-2 sm:px-8">
              <h4 className="text-lg sm:text-xl font-medium">Delivery Charges :</h4>
              <span className="text-lg sm:text-xl font-medium">₹100</span>
            </div>
            <div className="w-[100%] sm:w-[80%] flex justify-between items-center px-2 sm:px-8">
              <h4 className="text-lg sm:text-xl font-medium">Total :</h4>
              <span className="text-lg sm:text-xl font-medium">
                {formatPrice(totalPrice)}
              </span>
            </div>
            <div className="w-[100%] sm:w-[80%] flex justify-between items-center px-2 sm:px-8">
              <h4 className="text-lg sm:text-xl font-medium">Discount Applied :</h4>
              <span className="text-lg sm:text-xl font-medium">₹70</span>
            </div>
            <div className="w-[100%] sm:w-[80%] h-[1px] bg-zinc-500 opacity-50"></div>
            <div className="w-[100%] sm:w-[80%] flex justify-between items-center px-2 sm:px-8">
              <h4 className="text-xl sm:text-2xl font-medium">Order Total :</h4>
...
export const metadata = {
  title: `Quick Cart - Cart Products`,
};